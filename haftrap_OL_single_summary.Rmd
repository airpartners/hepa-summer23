...
is_file <- 'data/HAFTRAP/OL/modpm/OL_M_41181_sham_indoor.csv'
os_file <- 'data/HAFTRAP/OL/modpm/OL_M_41181_sham_outdoor.csv'
ih_file <- 'data/HAFTRAP/OL/modpm/OL_M_41181_hepa_indoor.csv'
oh_file <- 'data/HAFTRAP/OL/modpm/OL_M_41181_hepa_outdoor.csv'
```
...
```{r}
# Rename columns to unique category. Run this block only ONCE!
...
write.csv(summary_all, "summary/HAFTRAP/OL/modpm/s_OL_M_41181_quants.csv")
write.csv(N_sham, "summary/HAFTRAP/OL/modpm/s_OL_M_41181_corr_sham.csv")
write.csv(N_hepa, "summary/HAFTRAP/OL/modpm/s_OL_M_41181_corr_hepa.csv")
```
