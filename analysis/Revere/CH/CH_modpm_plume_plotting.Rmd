...
# Smooth curves
my_df_before_smoothed <- lowess(my_df_before$pm25, f=0.005)
my_df_after_smoothed <- lowess(my_df_after$pm25, f=0.005)
...
plume_redus <- function(data, id, pm, env) {
  ...
  # my_df_after_smoothed <- lowess(my_df_before[[pm]], f=0.005)
