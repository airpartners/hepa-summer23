...
main_df %>%
  ...
  pivot_longer(concent:inlttmp - CHANGE, 
...
write.csv(summary_normal, "summary/HAFTRAP/OH/joint/s_OH_MC_quants.csv")
write.csv(corr_df, "summary/HAFTRAP/OH/joint/s_OH_MC_corr.csv")
```