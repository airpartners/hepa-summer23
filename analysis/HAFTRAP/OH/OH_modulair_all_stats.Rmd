# HAFTRAP Data Summarization - multiple (for Modulair)

## STOP

**HAVE YOU RUN `OH_modulair_cleaning`?**
*This file loads a dataframe created from running `OH_modulair_cleaning`. Make sure you run that file first (if you haven't already) before running this file.*

This script is used to calculated summary statistics for multiple participants in the HAFTRAP study, for Modulair deployments by Olin.

Results can be found in `summary/HAFTRAP/OH/s_OH_R_quants.csv`.
...
write.csv(summary_normal, "summary/HAFTRAP/OH/s_OH_R_quants.csv")
```