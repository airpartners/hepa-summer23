...
This script is used to calculated summary statistics for multiple participants in the HAFTRAP study, for CPC deployments by Olin. It is largely a copy of `OH_modpm_single_stats.Rmd` without the data cleaning part found in `OH_modpm_cleaning`.
