...
## copy + paste vedaant's data formatting function, data cleaning + formatting function, set standard scaling for each pm, check colors (print out in black and white)
```
